...
<head>
    ...
    <title>investhood E-Learning</title>
...
<body >
 ...
 <div class="navbar navbar-inverse navbar-fixed-top " id="menu">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#"><img class="logo-custom" src="assets/img/log.jpg" width="100" height="" alt=""  /><p style="color:blue; font-family:Times New Roman,serif; font-size:50px;">Investhood E-Learning</a></p>
            </div>
            <div class="navbar-collapse collapse move-me">
                <ul class="nav navbar-nav navbar-right">
                    <li ><a href="#home">HOME</a></li>
                    <li><a href="#testimonials-sec">DEVELOPERS</a></li>
 ...
 <div class="container">
               ...
               <div class="col-lg-12  col-md-12 col-sm-12">
                ...
                <div class="flexslider set-flexi" id="main-section" >
                    <ul class="slides move-me">
                        <!-- Slider 01 -->
                        <li>
                                  <h1>Welcome to Investhood Online School</h1>
                                            <h4>APPLY NOW</h4>
		                    <h4><a  href="https://investhoodit.co.za/" type="button" class="btn btn-default" >More Information</a></h4>
                            <a href="index.php" type="button" class="btn btn-danger btn-lg">STUDENT</a>
                            <a href="index.php" type="button" class="btn btn-warning btn-lg">TEACHER</a>
							<a  href="admin/index.php" type="button" class="btn btn-primary btn-lg" >ADMIN</a>
                        </li>
                        <!-- End Slider 01 -->
    ...
    <div  class="tag-line" >
        ...
        <h2 data-scroll-reveal="enter from the bottom after 0.1s" ><i class="fa fa-circle-o-notch"></i>Welcome to Investhood Online School<i class="fa fa-circle-o-notch"></i> </h2>
                   </div>
               </div>
             </div>
         ...
         <div id="testimonials-sec" class="container set-pad" >
             <div class="row text-center">
                 <div class="col-lg-8 col-lg-offset-2 col-md-8 col-sm-8 col-md-offset-2 col-sm-offset-2">
                     <h1 data-scroll-reveal="enter from the bottom after 0.2s"  class="header-line">DEVELOPERS </h1>
           ...
           <div class="row" >
                 ...
                 <div class="col-lg-3  col-md-3 col-sm-3" data-scroll-reveal="enter from the bottom after 0.4s">
                     <div class="about-div">
                  <center>  <img class="img img-circle" src="assets/img/buhle.jpg" style="width:100px;height:100px;" />
                   <h3 >Lebogang Magopa</h3>
                 <hr />
                       <hr />
                   <p >
               ...
               <!--<a class="btn btn-info btn-set"  ></a> -->
                </div>
                   </div>
				   ...
				   <div class="col-lg-3  col-md-3 col-sm-3" data-scroll-reveal="enter from the bottom after 0.4s">
                     <div class="about-div">
                  <center>  <img class="img img-circle" src="assets/img/cliff.jpeg" style="width:100px;height:100px;" />
                   <h3 > Clifford<br /> Monama</h3>
                 <hr />
                       <hr />
                   <p >
				   ...
				   <br />
				    ...
				    <div class="col-lg-3  col-md-3 col-sm-3" data-scroll-reveal="enter from the bottom after 0.4s">
                     <div class="about-div">
                  <center>  <img class="img img-circle" src="assets/img/cindy.jpeg" style="width:100px;height:100px;" />
                   <h3 > Cindy<br /> Moumakwe</h3>
                 <hr />
                       <hr />
                   <p >
                  ...
                  <div class="col-lg-3  col-md-3 col-sm-3" data-scroll-reveal="enter from the bottom after 0.4s">
                     <div class="about-div">
                  <center>  <img class="img img-circle" src="assets/img/john.jpeg" style="width:100px;height:100px;" />
                   <h3 > Johnathan<br /> Sibiya</h3>
                 <hr />
                       <hr />
                   <p >
...
<br />
    ...
    <div class="col-lg-4 col-md-4 col-sm-4   col-lg-offset-1 col-md-offset-1 col-sm-offset-1 " data-scroll-reveal="enter from the bottom after 0.4s">
	  ...
	  <div class="icon"><img src="assets/img/address.png"/>
	  <h2 ><strong>Address </strong></h2> </div>
          <div class="contact-info">
                    
        <hr />
                    
                        <h4>136 2nd Street</h4>
                        <h4>Randjespark</h4>
						<h4>Mindrand</h4>
						<h4>1685</h4>
                 ...
                 <div class="col-lg-4 col-md-4 col-sm-4   col-lg-offset-1 col-md-offset-1 col-sm-offset-1" data-scroll-reveal="enter from the bottom after 0.4s">
                   <div class="icon"><img src="assets/img/phone.png"/></div>
                    <div class="contact-info">
                    <h2 ><strong>Phone number</strong></h2>
					
                             <hr />
                    <div >
                        <h4>Call: 068 246 0562</h4>
				  ...
				  <div class="col-lg-4 col-md-4 col-sm-4   col-lg-offset-1 col-md-offset-1 col-sm-offset-1 " data-scroll-reveal="enter from the bottom after 0.4s">
						  ...
						  <div class="icon"><img src="assets/img/email.png"/><h2 ><strong>Email </strong></h2> </div>
							  <div class="contact-info">
										
							<hr />
										
                                    <h4><strong>Email: </strong>admin@investhoodit.co.za</h4>
...
<!-- Script -->
     <!-- CONTACT SECTION END-->
    <div id="footer">
          &copy Investhood E-Learning 2022| All Rights Reserved |  <a style="color: #fff" target="_blank">Design by : Investhood IT</a>
    </div>
     <!-- FOOTER SECTION END-->
