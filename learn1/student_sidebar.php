<div class="span3" id="sidebar">
			...
			<li class="active"><a href="dashboard_student.php"><i class="icon-chevron-right"></i><i class="icon-group"></i>&nbsp;My Class</a></li>
				...
				<li class=""><a href="student_notification.php"><i class="icon-chevron-right"></i><i class="icon-info-sign"></i>&nbsp;Notification
				<?php if($not_read == '0'){
				}else{ ?>
			...
			<!-- <li class=""><a href="backpack.php"><i class="icon-chevron-right"></i><i class="icon-suitcase"></i>&nbsp;Backpack</a></li>-->
			 <li class=""><a href="https://www.google.com/search"><i class="icon-chevron-right"></i><i class="icon-search"></i>&nbsp;Google Search</a></li>
			 
			 <li class=""><a href="webvr/index.html"><i class="icon-chevron-right"></i><i class="icon-camera"></i>&nbsp;VR</a></li>
		</ul>
		
		<!--<a href="https://www.google.com/search" type="button" class="btn btn-primary btn-lg">Google Search</a>-->
		</br></br>
