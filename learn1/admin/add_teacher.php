   <div class="row-fluid">
					    ...
					    <?php
                            if (isset($_POST['save'])) {
                                ...
                                mysqli_query($conn,"insert into teacher (firstname,lastname,location,department_id,password,username)
								values ('$firstname','$lastname','uploads/NO-IMAGE-AVAILABLE.jpg','$department_id','$password','$username')         
								") or die(mysqli_error()); ?>
								<script>
